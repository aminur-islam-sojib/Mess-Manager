              ...
              <table role="presentation" style="width: 100%; margin: 20px 0;">
                <tr>
                  <td class="mobile-box" style="background-color: #f8fafb; border-radius: 12px; padding: 20px;">
                    ...
                    <table role="presentation" style="width: 100%;">
                      <tr>
                        <td style="padding: 8px 0; color: #666666; font-size: 14px;">✓ Track your daily meals and expenses</td>
                      </tr>
                      <tr>
                        <td style="padding: 8px 0; color: #666666; font-size: 14px;">✓ View your balance and payment history</td>
                      </tr>
                      <tr>
                        <td style="padding: 8px 0; color: #666666; font-size: 14px;">✓ Get notified for due payments</td>
                      </tr>
                    </table>
                  </td>
                </tr>
